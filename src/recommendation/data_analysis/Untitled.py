...
def rank_func(prior_and_orders):
    ...
    prior_and_orders2=pd.merge(prior_and_orders, count, how='outer')
    return prior_and_orders2

prior=rank_func(order_prior)
...
def prod_order_rank_func(prior_and_orders):
    ...
    prior_and_orders2=pd.merge(prior_and_orders, order_series_rank, how='outer')
    return prior_and_orders2

prod=prod_order_rank_func(prior)
